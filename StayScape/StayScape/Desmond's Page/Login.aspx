                                ...
                                <div class="col-lg-8 col-11 mx-auto">
                                    <asp:Panel runat="server" ID="pnlSignIn">
                                        <div class="form-floating mb-4 p-0">
                                            ...
                                            <asp:TextBox runat="server" ID="txtEmail" CssClass="form-control" placeholder="Email address" Required="true"></asp:TextBox>
                                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        <a href="#">
                            <img border="0" alt="" src="assets/house-transparent.png" width="200" height="200">
                        </a>
